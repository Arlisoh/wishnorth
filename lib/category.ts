...
const RULES: Array<{ category: WishCategory; words: string[] }> = [
  ...
  { category: "Clothing & Accessories", words: ["shirt", "t-shirt", "tee", "hoodie", "sweatshirt", "sweater", "jacket", "coat", "jeans", "pants", "dress", "skirt", "shorts", "shoe", "sneaker", "boot", "sandals", "hat", "cap", "gloves", "scarf", "bag", "backpack", "purse", "wallet", "belt", "socks", "underwear", "clothing", "apparel"] },
  ...
  { category: "Food & Drink", words: ["chocolate", "candy", "coffee", "tea", "snack", "food", "cookies", "cake", "wine", "beer", "bourbon", "whiskey", "drink"] },
